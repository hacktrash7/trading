...
BUDGET_CATEGORIES = [
    ...
    ("Restaurant dining (weekdays)", 5253, 500, "Rare weekday sit-down; weekends use weekend envelope"),
    ("Street food / canteen (weekdays)", 3594, 2500, "Mon–Fri office lunch — use Infosys cafeteria"),
...
def build_monthly_plan_sheet(wb):
    ...
    plan = [
        ...
        (9, "Cursor AI + subscriptions", 1700, "Monthly", "Salary"),
        (10, "Healthcare / pharmacy (buffer only)", 200, "As needed — June was one-time", "Salary"),
